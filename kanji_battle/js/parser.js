...
// 5年生データも193字ぶんを5バッチに分けて取得したため、ここでまとめる。
const KANJIVG_DATA_GRADE5 = Object.assign(
  {},
  KANJIVG_DATA_GRADE5_BATCH1,
  KANJIVG_DATA_GRADE5_BATCH2,
  KANJIVG_DATA_GRADE5_BATCH3,
  KANJIVG_DATA_GRADE5_BATCH4,
  KANJIVG_DATA_GRADE5_BATCH5
);
const GRADE5_CHARACTERS = [].concat(
  GRADE5_CHARACTERS_BATCH1,
  GRADE5_CHARACTERS_BATCH2,
  GRADE5_CHARACTERS_BATCH3,
  GRADE5_CHARACTERS_BATCH4,
  GRADE5_CHARACTERS_BATCH5
);

// 6年生データも191字ぶんを5バッチに分けて取得したため、ここでまとめる。
const KANJIVG_DATA_GRADE6 = Object.assign(
  {},
  KANJIVG_DATA_GRADE6_BATCH1,
  KANJIVG_DATA_GRADE6_BATCH2,
  KANJIVG_DATA_GRADE6_BATCH3,
  KANJIVG_DATA_GRADE6_BATCH4,
  KANJIVG_DATA_GRADE6_BATCH5
);
const GRADE6_CHARACTERS = [].concat(
  GRADE6_CHARACTERS_BATCH1,
  GRADE6_CHARACTERS_BATCH2,
  GRADE6_CHARACTERS_BATCH3,
  GRADE6_CHARACTERS_BATCH4,
  GRADE6_CHARACTERS_BATCH5
);

// KANJI_DATA配列を構築 (1年生 + 2年生 + 3年生 + 4年生 + 5年生 + 6年生)
const KANJI_DATA = [
  ...
  ...buildKanjiEntries(GRADE5_CHARACTERS, KANJIVG_DATA_GRADE5, 5),
  ...buildKanjiEntries(GRADE6_CHARACTERS, KANJIVG_DATA_GRADE6, 6),
];
